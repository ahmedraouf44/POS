        ...
        <ul class="sidebar-menu" data-widget="tree">
            ...
            <li class="treeview">
                ...
                <ul class="treeview-menu">
                    <li><a href=""><i class="fa fa-plus"></i> Add Slider</a></li>
                    <li><a href=""><i class="fa fa-edit"></i> Show / Edit Slide</a></li>
                </ul>
            </li>
            ...
            <li class="treeview">
                ...
                <ul class="treeview-menu">
                    <li><a href=""><i class="fa fa-plus"></i> Add Service</a></li>
             ...
             <li class="treeview">
                ...
                <ul class="treeview-menu">
                    <li><a href="{{adminUrl('Service_product')}}"><i class="fa fa-plus"></i> List Products</a></li>
                    <li><a href="{{adminUrl('Service_product/create')}}"><i class="fa fa-plus"></i> create</a></li>
            ...
            <li class="treeview">
                ...
                <ul class="treeview-menu">
                    ...
                    <li><a href="{{adminUrl('billboard1/createProduction')}}"><i class="fa fa-plus"></i> Add Production Billboard</a></li>
                    <li><a href="{{adminUrl('billboard')}}"><i class="fa fa-edit"></i> Show / Edit Billboard</a></li>
                    <li><a href="{{adminUrl('billboard1/indexProduction')}}"><i class="fa fa-edit"></i> Show / Edit Production Billboard</a></li>
            ...
            <li class="treeview">
                ...
                <ul class="treeview-menu">
                    <li><a href="{{adminUrl('user')}}"><i class="fa fa-edit"></i> Show Users</a></li>
                </ul>
            </li>
            <li class="treeview">
                <a href="#">
                ...
                <ul class="treeview-menu">
                    <li><a href="{{adminUrl('admin')}}"><i class="fa fa-edit"></i> Show Admins</a></li>
                </ul>
            </li>
