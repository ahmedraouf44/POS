...
<body>
<div class="log-form">
    <div class="row m-0 log-cont">
        <div class="group">
        <div class="card">
        <div class="card-header">
        <h1 style="color: #551646">تسجيل دخول</h1>
        </div>
        ...
        <div class="card-body">
            <form method="POST" action="{{ route('login') }}">
                ...
                <div class="form-group row">
                    <label for="password" class="col-md-2 col-form-label text-md-right">{{ __('كلمة المرور') }}</label>
            ...
            <div class="logo">
                <div>
                    <img src="image/logo-large.png" alt="">
                </div>
            </div>
        </div>
    </div>
